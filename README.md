...
[![CI](https://github.com/hba/ansible-role-nginx/workflows/CI/badge.svg?event=push)](https://github.com/hba/ansible-role-nginx/actions?query=workflow%3ACI)
...
Create the child template in the path you configured above and extend `hba.nginx` template file relative to your `playbook.yml`.

```
{% extends 'roles/hba.nginx/templates/nginx.conf.j2' %}
